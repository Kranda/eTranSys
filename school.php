...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<!-- Adding Carousel  -->
	   <div class="container">
	   	  <h1 class="text-center">Colleges and Universities</h1>
...
<div class="container">
    <div class="row mt-4">
          <div class="col-12 text-center">
            ...
            <p class="linksimage text-center"><i class="fas fa-graduation-cap text-center"></i></p>
            <p class="text-center"><a href="college_login.php">Click to Login</a></p>
            <p class="text-center"><a href="register.php">Click to Signup</a></p>
          </div>
